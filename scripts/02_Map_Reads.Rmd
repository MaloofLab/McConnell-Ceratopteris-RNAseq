...
for f1 in $R1_files
  do
    ...
    samtools index $out_dir/$out_fileAligned.sortedByCoord.out.bam
    samtools index $out_dir/$out_file2Aligned.sortedByCoord.out.bam
...
htseq-count --stranded=no --idattr=Parent --order=pos *.bam $gff > $out_file
