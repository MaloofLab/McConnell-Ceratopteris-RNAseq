...
## LFY1 network
```{r, message=FALSE}
path <- "../output/TGCN_LFY1_gam_no4.5DAG"
...
```{r}
knitr::include_graphics("../output/TGCN_LFY1_gam_no4.5DAG/results/LFY1_gam_c6_TGCN_crossTabPlot.png")
```
...
## LFY2 network
```{r, message=FALSE}
path <- "../output/TGCN_LFY2_gam_no4.5DAG"
...
```{r}
knitr::include_graphics("../output/TGCN_LFY2_gam_no4.5DAG/results/LFY2_gam_c5_TGCN_crossTabPlot.png")
```
...
```{r}
LFY1.c5 <- read_csv("../output/TGCN_LFY1_gam_no4.5DAG/results/LFY1_gam_c5_TGCN.csv")
LFY1.c5
```
...
```{r}
LFY1.c6 <- read_csv("../output/TGCN_LFY1_gam_no4.5DAG/results/LFY1_gam_c6_TGCN.csv")
LFY1.c6
```
...
```{r}
LFY2.c5 <- read_csv("../output/TGCN_LFY2_gam_no4.5DAG/results/LFY2_gam_c5_TGCN.csv")
LFY2.c5
```
