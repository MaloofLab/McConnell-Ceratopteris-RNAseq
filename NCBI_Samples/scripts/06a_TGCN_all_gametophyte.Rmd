...
```{r}
knitr::include_graphics("../output/TGCN_LFY1_gam/results/LFY1_gam_c6_TGCN_crossTabPlot.png")
```
...
```{r}
knitr::include_graphics("../output/TGCN_LFY2_gam/results/LFY2_gam_c5_TGCN_crossTabPlot.png")
```
...
```{r}
LFY1.c5 <- read_csv("../output/TGCN_LFY1_gam/results/LFY1_gam_c5_TGCN.csv")
LFY1.c5
```
...
```{r}
LFY1.c6 <- read_csv("../output/TGCN_LFY1_gam/results/LFY1_gam_c6_TGCN.csv")
LFY1.c6
```
...
```{r}
LFY2.c5 <- read_csv("../output/TGCN_LFY2_gam/results/LFY2_gam_c5_TGCN.csv")
LFY2.c5
```
