# McConnell-Ceratopteris-RNAseq
C-fern RNAseq analysis of LFY RNAi and overexpressors

For McConnell 2026 Paper on Male vs Hermaphrodite Gametophytes:
...
`NCBI_Samples/scripts/09.2_MR_intersection_with_gametophyte_sexDE_noSexMR.Rmd`
...
## Table 5 and Supplemental Table Y script:

`McConnell-Ceratopteris-RNAseq/NCBI_Samples/scripts/09.2_MR_intersection_with_gametophyte_sexDE_noSexMR.Rmd`

## Reanalysis of Atallah data and comparison with this dataset
