---
title: "09b_WT_male_v_hermaphrodite_no_filter"
author: "Julin Maloof"
date: "`r Sys.Date()`"
...
In this version no low-read count filtering is done
...
keep all genes with at least 1 count

```{r}
counts.data <- counts.data[rowSums(counts.data[,-1] > 0) >= 1,]
```
...
#dev.copy(png, filename = "../output/male_v_herm_heatmap_tall_no_filter.png", width=1200, height = 1800)

#genes.heatmap.reorder <- genes.heatmap[rev(match(colnames(hm$carpet),genes.heatmap$geneID)),]

#write_csv(genes.heatmap.reorder, "../output/male_v_herm_heatmap_genes_ordered_no_filter.csv")
```
...
#dev.copy(png, filename = "../output/male_v_herm_heatmap_tall_centered_no_filter.png", width=1200, height = 1800)

genes.heatmap.reorder.centered <- genes.heatmap[rev(match(colnames(hm.centered$carpet),genes.heatmap$geneID)),]

#write_csv(genes.heatmap.reorder.centered, "../output/male_v_herm_heatmap_genes_ordered_centered_no_filter.csv")
```
...
```{r}
#save to a file
write_csv(genes.all,"../output/DEG_ALL_WT_male_v_herm_no_filter.csv.gz")
```
...
write.csv(GO.out.up, "../output/GO_up_WT_male_v_herm_no_filter.csv")
```
...
write.csv(GO.out.down, "../output/GO_down_WT_male_v_herm_no_filter.csv")
